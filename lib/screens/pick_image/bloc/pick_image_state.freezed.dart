...
mixin _$PickImageState {
  PickImageStatus get status => throw _privateConstructorUsedError;
...
abstract class $PickImageStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({PickImageStatus status, String? path});
}
...
class _$_PickImageState implements _PickImageState {
  _$_PickImageState({required this.status, required this.path});
  ...
  @override
  String toString() {
    return 'PickImageState(status: $status, path: $path)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, path);
...
abstract class _PickImageState implements PickImageState {
  factory _PickImageState(
      {required final PickImageStatus status,
      required final String? path}) = _$_PickImageState;

  @override
  PickImageStatus get status;
  @override
  String? get path;
  @override
  @JsonKey(ignore: true)
